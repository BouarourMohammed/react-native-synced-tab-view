...
import { GridTab } from "@/components/instagram/profile/components/tab1";
import { ReelsTab } from "@/components/instagram/profile/components/tab2";
import { TaggedTab } from "@/components/instagram/profile/components/tab3";
import {
...
} from "@/components/instagram/profile/components/shared";
      ...
      [
        {
          ...
          component: ({ index, width }: TabPageProps) => (
            <GridTab index={index} width={width} imageSize={imageSize} />
          ),
        },
        {
          key: "reels",
        ...
        },
        {
          ...
          icon: "person-outline",
          component: ({ index, width }: TabPageProps) => (
            <TaggedTab index={index} width={width} imageSize={imageSize} />
          ),
        },
      ] satisfies TabItem[],
