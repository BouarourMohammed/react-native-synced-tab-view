...
import { GridTab } from "@/components/instagram/profile-tab-legend-list/components/tab1";
import { ReelsTab } from "@/components/instagram/profile-tab-legend-list/components/tab2";
import { TaggedTab } from "@/components/instagram/profile-tab-legend-list/components/tab3";
import {
...
} from "@/components/instagram/profile-tab-legend-list/components/shared";

const RESET_PREVIOUS_SCROLLING_Y = true;
...
export default function InstagramProfileTabLegendListScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <SyncedTabsLayout
        ...
        tabsProviderProps={{
          resetPreviousScrollingY: RESET_PREVIOUS_SCROLLING_Y,
        }}
